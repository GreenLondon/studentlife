...
var app = {
	...
	route: function(event) {
		var homePage =
    		'<div class="home"><div class="loader"><img src="www/images/loader.gif"/></div> <div id="featured-main"><div class="main-story hidden_div"></div><div class="sub-stories hidden_div"></div></div><ul class="topcoat-list hidden_div"></ul><div class="banner hidden_div"></div></div>';
