...
var app = {
	...
	route: function(event) {
		var homePage =
    		'<div class="home"><div class="loader"><img src="www/images/loader.gif"/></div> <div id="featured-main" class="hidden_div"><div class="main-story"></div><div class="sub-stories"></div></div><ul class="topcoat-list"></ul><div class="banner"></div></div>';
